...
class CreateAccountActivityTest {
    ...
    @Rule
    @JvmField
    var mActivityTestRule = ActivityTestRule(edu.gatech.transact.views.CreateAccountActivity::class.java)

    @Test
    fun createAccountActivityTest() {
        ...
        appCompatEditText3.perform(replaceText("aaa"), closeSoftKeyboard())

        val appCompatEditText4 = onView(
            allOf(
                withId(R.id.etEmail), withText("aaa"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        appCompatEditText8.perform(replaceText("aaajax"))

        val appCompatEditText9 = onView(
            allOf(
                withId(R.id.etEmail), withText("aaajax"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        appCompatEditText14.perform(replaceText("aaajaxx"))

        val appCompatEditText15 = onView(
            allOf(
                withId(R.id.etEmail), withText("aaajaxx"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
        ...
        appCompatEditText19.perform(replaceText("aaajaxx@"))
        ...
        val materialButton = onView(
            allOf(
                withId(R.id.btnCreateAccount), withText("SIGN UP"),
                childAtPosition(
                    childAtPosition(
                        withId(android.R.id.content),
                        0
